...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='Martix'' package/lean/default-settings/files/zzz-default-settings
sed -i "s/MartixWrt /thomaswcy build $(TZ=UTC-8 date "+%Y.%m.%d") @ Martix /g" package/lean/default-settings/files/zzz-default-settings
...
echo -e " MartixWrt built by thomaswcy on "$(date +%Y.%m.%d)"\n -----------------------------------------------------" >> package/base-files/files/etc/banner
