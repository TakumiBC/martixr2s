...
echo "Welcome to the RubikWrt NanoPi R2S Update Script (Stable Firmware)"
echo "Downloading the latest release of stable firmware"
wget -P /tmp https://github.com/thomaswcy/R2S/releases/download/$(date +%Y.%m.%d)-R2Sstable/openwrt-rockchip-armv8-friendlyarm_nanopi-r2s-ext4-sysupgrade.img.gz
